...
public class ThemeSelectGridLayout extends GridLayout {
    ...
    private void initThemes(Context context) {
        ...
        v.setColors(R.color.theme_blue_action_bar_bg, R.drawable.theme_blue_list_light_oval_bg,
                R.drawable.theme_blue_list_dark_oval_bg,
        ...
        v.setColors(R.color.theme_white_action_bar_bg, R.drawable.theme_white_list_light_oval_bg,
                R.drawable.theme_white_list_dark_oval_bg,
        ...
        gl = getGridLayoutParams(context, margin);
        v = new ThemeSample(context);
        v.setColors(R.color.theme_black_action_bar_bg, R.drawable.theme_black_list_light_oval_bg,
                R.drawable.theme_black_list_dark_oval_bg,
        ...
        gl = getGridLayoutParams(context, margin);
        v = new ThemeSample(context);
        v.setColors(R.color.theme_orange_action_bar_bg, R.drawable.theme_orange_list_light_oval_bg,
                R.drawable.theme_orange_list_dark_oval_bg,
                R.drawable.theme_orange_list_selected_item_oval_bg, R.color.theme_orange_action_bar_bg,
        ...
        gl = getGridLayoutParams(context, margin);
        v = new ThemeSample(context);
        v.setColors(R.color.theme_yellow_action_bar_bg, R.drawable.theme_yellow_list_light_oval_bg,
                R.drawable.theme_yellow_list_dark_oval_bg,
                R.drawable.theme_yellow_list_selected_item_oval_bg, R.color.theme_yellow_action_bar_bg,
        ...
        gl = getGridLayoutParams(context, margin);
        v = new ThemeSample(context);
        v.setColors(R.color.theme_gray_action_bar_bg, R.drawable.theme_gray_list_light_oval_bg,
                R.drawable.theme_gray_list_dark_oval_bg,
        ...
        gl = getGridLayoutParams(context, margin);
        v = new ThemeSample(context);
        v.setColors(R.color.theme_navy_action_bar_bg, R.drawable.theme_navy_list_light_oval_bg,
                R.drawable.theme_navy_list_dark_oval_bg,
        ...
        gl = getGridLayoutParams(context, margin);
        v = new ThemeSample(context);
        v.setColors(R.color.theme_purple_action_bar_bg, R.drawable.theme_purple_list_light_oval_bg,
                R.drawable.theme_purple_list_dark_oval_bg,
                R.drawable.theme_purple_list_selected_item_oval_bg, R.color.theme_purple_action_bar_bg,
        ...
        gl = getGridLayoutParams(context, margin);
        v = new ThemeSample(context);
        v.setColors(R.color.theme_simple_white_action_bar_bg, R.drawable.theme_simple_white_list_light_oval_bg,
                R.drawable.theme_simple_white_list_dark_oval_bg,
                R.drawable.theme_simple_white_list_selected_item_oval_bg, R.color.theme_simple_white_action_bar_bg,
